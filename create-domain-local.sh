...
# Validasi argumen
if [ "$#" -ne 3 ]; then
    echo "Usage: $0 <source_port> <project_name> <domain>"
    exit 1
fi
...
# 4. Reload Nginx di dalam Docker tanpa menghentikan semua container
echo "Reloading Nginx configuration in container..."
